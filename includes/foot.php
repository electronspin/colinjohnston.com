...
<div id="pagebottom">
    <div>
      <div class="row">
        ...
        <p class="copyright">&copy; 2012-2015 Colin Johnston. Hand-coded in Sublime Text using Foundation / Sass / PHP / jQuery. <!-- An <a href="http://electronspin.com" title="Electron Spin">Electron Spin</a> production. --> Updated <?php echo date ('F d Y', filemtime($dir));  ?>
        </div>
