...
<div id="saffo-home-responsive" class="reveal-modal expand modal modal-img-border">
    <h2>Paul Saffo Homepage</h2>
    <img src="/images/saffo-homepage_full.jpg" alt="Paul Saffo Homepage">
    <p><a href="http://www.saffo.com/" name="" target="_blank">www.saffo.com</a></p>
    <a class="close-reveal-modal">&#215;</a>
</div>
<!-- icon creation -->
<div id="saffo-identity-icons-sketch" class="reveal-modal expand modal modal-img-border">
    <h2>Paul Saffo Identity - Icon Designs</h2>
    <img src="/images/saffo-identity-icons-sketch_full.jpg" alt="Paul Saffo Identity - Icon Sketches">
    <p></p>
    <a class="close-reveal-modal">&#215;</a>
</div>
<div id="saffo-identity-icons-wip" class="reveal-modal expand modal modal-img-border">
    <h2>Paul Saffo Identity - Icon Designs</h2>
    <img src="/images/saffo-identity-icons-wip_full.jpg" alt="Paul Saffo Identity - Icon Designs">
    <p></p>
    <a class="close-reveal-modal">&#215;</a>
</div>
<div id="saffo-identity-icons-final" class="reveal-modal expand modal modal-img-border">
    <h2>Paul Saffo Identity - Icon Designs</h2>
    <img src="/images/saffo-identity-icons-final_full.jpg" alt="Paul Saffo Identity - Final Icon Designs">
    <p></p>
    <a class="close-reveal-modal">&#215;</a>
</div>
<!-- sketches -->
