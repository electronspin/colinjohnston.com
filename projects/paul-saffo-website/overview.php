        ...
        <ul class="tabs-content">
            ...
            <li class="content" id="processTab">
                <div class="overview-content">
                    ...
                    <p class="hide-for-small case-caption"><strong>Icon Design</strong> - Constructing the About Icon in Illustrator. / <a href="#" data-reveal-id="saffo-identity-icons-wip">View Larger Image</a></p>
                    ...
                    <p class="hide-for-small case-caption"><strong>Icon Design</strong> - The final icons ready for SVG export. / <a href="#" data-reveal-id="saffo-identity-icons-final">View Larger Image</a></p>
                    ...
                    <p class="hide-for-small case-caption"><strong>Mockups</strong> - Designing the desktop and mobile views side-by-side in Sketch. / <a href="#" data-reveal-id="saffo-design-sketch-1">View Larger Image</a></p>
                    <div class="imagebox">
                        ...
                        /images/saffo-design-sketch-2_large.jpg 1200w" sizes="(min-width: 48em) 66.6vw, 100vw" src="/images/saffo-design-sketch-2_medium.jpg" alt="Paul Saffo Website - Design in Sketch 2">
                        </a>
                    </div>
                    <p class="hide-for-small case-caption"><strong>Mockups</strong> - Detail of mobile navigation in Sketch. / <a href="#" data-reveal-id="saffo-design-sketch-2">View Larger Image</a></p>
                </div>
            </li>
        </ul>
    </div>
