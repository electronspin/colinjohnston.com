        ...
        <ul class="tabs-content">
            <li class="content active" id="overviewTab">
                ...
                <div class="overview-content">
                    ...
                    <!-- <p>For more about the icon and logo design, please see ‘[Paul Saffo Identity Redesign](#)’ in the Branding section of my portfolio.
        </p> -->
                    ...
                    <!-- <p>For a detailed walk-through of my design and development process, see '[Process](#)' below.
        </p> -->
